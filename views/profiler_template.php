...
<a href="#" id="ci-profiler-menu-open" class="<?php echo $bar_location ?>" onclick="ci_profiler_bar.open();
        return false;" style="width: 2em">&nbsp;</a>
...
<?php if (isset($sections['console'])) : ?>
            <a href="#" id="ci-profiler-menu-console" onclick="ci_profiler_bar.show('ci-profiler-console', 'ci-profiler-menu-console');
                    return false;">
...
<?php if (isset($sections['benchmarks'])) : ?>
            ...
            <a href="#" id="ci-profiler-menu-memory" onclick="ci_profiler_bar.show('ci-profiler-memory', 'ci-profiler-menu-memory');
                    return false;">
...
<?php endif; ?>
        ...
        <?php if (isset($sections['queries'])) : ?>
            <a href="#" id="ci-profiler-menu-queries" onclick="ci_profiler_bar.show('ci-profiler-queries', 'ci-profiler-menu-queries');
                    return false;">
...
<?php if (isset($sections['eloquent'])) : ?>
            <a href="#" id="ci-profiler-menu-eloquent" onclick="ci_profiler_bar.show('ci-profiler-eloquent', 'ci-profiler-menu-eloquent');
                    return false;">
        ...
        <?php if (isset($sections['http_headers']) || isset($sections['get']) || isset($sections['config']) || isset($sections['post']) || isset($sections['uri_string']) || isset($sections['controller_info'])) : ?>
            <a href="#" id="ci-profiler-menu-vars" onclick="ci_profiler_bar.show('ci-profiler-vars', 'ci-profiler-menu-vars');
                    return false;">
...
<?php endif; ?>
    ...
    <?php endif; ?>
        ...
        <a href="#" id="ci-profiler-menu-exit" onclick="ci_profiler_bar.close();
                return false;" style="width: 2em; height: 2.1em"></a>
    </div>
                    ...
                    <table class="main">
                        <?php foreach ($sections['console']['console'] as $log) : ?>
                                ...
                                <tr>
                                    ...
                                    <td class="faded"><pre class="console-pre"><?php echo $log['data'] ?></pre></td>
                    							<td></td>
                    						</tr>
            ...
            <?php if (isset($sections['http_headers']) || isset($sections['get']) || isset($sections['config']) || isset($sections['post']) || isset($sections['uri_string']) || isset($sections['controller_info']) || isset($sections['userdata'])) : ?>
        		<div id="ci-profiler-vars" class="ci-profiler-box" style="display: none">
                    ...
                    <?php if (isset($sections['userdata'])) : ?>
            					<a href="#" onclick="ci_profiler_bar.toggle_data_table('userdata');
                                                            return false;">
        ...
        <?php foreach (array('get', 'post', 'uri_string', 'controller_info', 'headers', 'config') as $section) : ?>
                        ...
                        <a href="#" onclick="ci_profiler_bar.toggle_data_table('<?php echo $section ?>');
                                return false;">
